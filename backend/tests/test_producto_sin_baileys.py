...
def test_el_reset_no_separa_identidad_y_signal_store():
    ...
    # La carpeta ENTERA, de una vez. Borrar fichero a fichero es como se
    # fabrico la identidad mezclada: uno quedaba bloqueado y se saltaba.
    assert "session_dir_baileys" in cuerpo, "la sesion es la carpeta, no un fichero"
    assert "rmtree" in cuerpo, "las dos van juntas o no va ninguna"
