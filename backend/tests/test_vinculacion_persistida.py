...
def test_se_persiste_ANTES_de_anunciar_el_estado():
    ...
    # El motivo dejo de nombrar el `<success>` de pywhats: ahora la senal es
    # `session_valid`, un evento del contrato que emite el proveedor.
    posicion_estado = fuente.find('AppState.CONNECTED, reason="sesion aceptada"')
