...
#: Codigos de salida que distinguen POR QUE no arranco.
#:
#: Un 1 generico obliga a leer el log para saber si hay otra instancia, si el
#: puerto esta cogido o si fallo de verdad. Con estos, un script que envuelva
#: al servicio puede decidir solo.
SALIDA_YA_HAY_SERVICIO = 3
SALIDA_PUERTO_OCUPADO = 4
