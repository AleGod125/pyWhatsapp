...
class ReconcileReport:
    ...
    def __str__(self) -> str:
        return (
            ...
            f"previas={self.previews_updated} ({self.duration_ms} ms)"
        )
...
def _real_wamid_filter() -> Any:
    from app.repository import SYNTHETIC_PREFIXES
...
class MaintenanceService:
    ...
    def reconcile_message_types(
        ...
        * nunca borra una fila, ni ``raw_proto``, ni un texto ya guardado.
        ...
        """
        from app.message_parser import interpret_message_bytes, parse_web_message_info
...
def _read_identity_records(
    ...
    """
    from app.message_parser import top_level_fields
