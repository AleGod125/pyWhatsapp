...
from app.message_classifier import classify_parsed, is_internal
from app.message_parser import ParsedMessage, classify_chat, parse_web_message_info
...
def ingest_history_sync(
    ...
    *,
    ...
    if signal_db is not None:
        from app.lid_bridge import sync_lid_map
