...
class Settings:
    ...
    compat_own_lid_map: bool
    compat_appstate_seeds: bool
...
def load_settings(*, env_file: Path | None = None, override: bool = False) -> Settings:
    ...
    settings = Settings(
        ...
        compat_own_lid_map=_bool("COMPAT_OWN_LID_MAP", True),
        compat_appstate_seeds=_bool("COMPAT_APPSTATE_SEEDS", False),
    )
